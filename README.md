This is a Django-based travel web application that allows users to explore places in Navi Mumbai and Mumbai Location in their free time. It includes a secure admin panel for managing locations, user login, and user feedback through rating system. Built using Python, Django, HTML, CSS, and SQLite. This web app is made specially for the students who are searching for the locations to hangout in their break time as well as to know the unhidden places. This contains Rating of particular location, Photos , Map to help locate the place.
...
*Admin Page
<img width="1918" height="939" alt="image" src="https://github.com/user-attachments/assets/5fc69950-3c23-4d57-99ce-055626acad6f" />

*Location Page
<img width="1906" height="842" alt="image" src="https://github.com/user-attachments/assets/9c243558-ec81-4c83-8f7b-f5be9a0b2912" />

*Login Page
<img width="1890" height="850" alt="image" src="https://github.com/user-attachments/assets/ff3aaf9a-92c1-4aa2-a7b6-48976847e764" />

### Developed By
Amrita Bera
[Computer Engineering Graduate | Python & Django Developer | ML Enthusiast]
